""" 
  ...
  * Statement:Write a Program to play a Cross Game or Tic-Tac-Toe Game. Player 1 is the Computer and the Player 2 is the user. Player 1 take Random Cell that is the Column and Row.
...
class TicTacToe:
    ...
    def userTurn(self):
        ...
        while userPosition in self.userPosition or userPosition in self.computerPosition:#search for emty position
    ...
    def computerTurn(self):
        ...
        while compPosition in self.userPosition or compPosition in self.computerPosition:#search for emty position
            print("Position Allready filled ! Enter another position")
            return self.computerTurn()
    ...
    def placePosition(self, player, pos):
        """Method Defination
           Operation:for position inserting symbols in board array
           :return
           """
        symbol = ' '
        if player == 'user':
    ...
    def findWinner(self):
        """Method Definition
          Operation:checking who is win the game
